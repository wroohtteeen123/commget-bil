...
def proc_data_cb(db_host="localhost", db_user="root", db_password="root", db_database="PyTest", table_name="XY"):
...
proc_data_cb(db_host="localhost", db_user="root", db_password="root", db_database="PyTest", table_name="XY")